---
description: "Install tracely-ai and trace your first AI agent run in three lines of Python. Requires Python 3.10+ and one provider extra."
---
...
- [MCP server](/mcp) — read those traces (and write evaluators) from your coding agent, no glue code.
