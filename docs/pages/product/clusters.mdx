...
A cluster being *new* is the signal worth interrupting someone for: it means a failure mode nobody
has triaged just appeared in production. Set that up once under
[Alerts](/product/alerts) — trigger **New failure mode**, one Slack channel — and this page becomes
somewhere you arrive already knowing why.
